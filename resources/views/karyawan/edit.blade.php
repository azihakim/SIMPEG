                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input value="{{ $karyawan->pendidikan_terakhir }}" type="text" class="form-control" name="pendidikan_terakhir" placeholder="Masukkan Pendidikan Terakhir">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Agama</label>
                            <input value="{{ $karyawan->agama }}" type="text" class="form-control" name="agama" placeholder="Masukkan Agama">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
